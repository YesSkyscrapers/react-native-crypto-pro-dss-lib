...
/*!
 * \file $RCSfile$
 * \version $Revision: 190256 $
 * \date $Date:: 2019-03-12 16:25:24 +0400#$
...
#include<CPROCSP/pki_ocsp_assembly.h>
#           ifdef _WIN64
#               pragma comment(linker,"/manifestdependency:\"type='win32' " \
                "name='" PKI_OCSP_ASSEMBLY_NAME "' " \
                "version='" PKI_OCSP_ASSEMBLY_VERSION "' " \
                "processorArchitecture='amd64' " \
                "language='*' " \
                "publicKeyToken='" PKI_OCSP_ASSEMBLY_PUBLICKEYTOKEN "'\"")
#           else
#               pragma comment(linker,"/manifestdependency:\"type='win32' " \
                "name='" PKI_OCSP_ASSEMBLY_NAME "' " \
                "version='" PKI_OCSP_ASSEMBLY_VERSION "' " \
