...
#include<CPROCSP/pki_ocsp_client_assembly.h>
            #ifdef _WIN64
                #pragma comment(linker,"/manifestdependency:\"type='win32' " \
                "name='" PKI_OCSP_CLIENT_ASSEMBLY_NAME "' " \
                "version='" PKI_OCSP_CLIENT_ASSEMBLY_VERSION "' " \
                "processorArchitecture='amd64' " \
                "language='*' " \
                "publicKeyToken='" PKI_OCSP_CLIENT_ASSEMBLY_PUBLICKEYTOKEN "'\"")
            #else
                #pragma comment(linker,"/manifestdependency:\"type='win32' " \
                "name='" PKI_OCSP_CLIENT_ASSEMBLY_NAME "' " \
                "version='" PKI_OCSP_CLIENT_ASSEMBLY_VERSION "' " \
