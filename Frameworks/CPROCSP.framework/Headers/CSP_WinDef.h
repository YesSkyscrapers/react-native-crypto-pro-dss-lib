...
typedef int                 CSP_BOOL;
typedef unsigned char       BYTE;
typedef unsigned short      WORD;
typedef float               FLOAT;
typedef FLOAT               *PFLOAT;
typedef CSP_BOOL near           *PCSP_BOOL;
typedef CSP_BOOL far            *LPCSP_BOOL;
...
WideCharToMultiByte(
  ...
  LPCSP_BOOL lpUsedDefaultChar  // set when default char used
);

/*Конец определений из WinNls.h*/

WINBASEAPI DWORD WINAPI CSP_GetLastError(void);
